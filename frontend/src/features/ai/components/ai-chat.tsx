...
export const AiChat = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: '1',
      role: 'assistant',
      content: "Hi, I'm TaskOrbit AI. I can analyze team performance, generate sprint plans, detect project risks, assign tasks intelligently, and provide actionable insights."
    }
  ]);
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Failed to communicate with TaskOrbit AI');
      setMessages((prev) => [
        ...prev,
        {
          id: Date.now().toString(),
    ...
    <Card className="flex h-[600px] flex-col shadow-none">
      <CardHeader className="border-b bg-muted/30 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-xl font-bold">TaskOrbit AI Assistant</CardTitle>
      ...
      <CardFooter className="border-t p-4 pb-4">
        <form onSubmit={handleSend} className="flex w-full items-center gap-2">
          <Input 
            ...
            placeholder="Ask TaskOrbit AI to analyze workload, predict risks..."
