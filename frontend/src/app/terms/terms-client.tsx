...
const sections = [
  {
    ...
    icon: ShieldCheck,
    content: 'By accessing or using Verto, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site. These Terms of Service constitute a legally binding agreement between you and Verto concerning your access to and use of our platform.'
  },
  {
    id: 'service',
    title: '2. Description of Service',
    icon: Layers,
    content: 'Verto is an AI-powered project management and collaboration platform. It offers sprint planning, workload analysis, risk prediction, and collaboration dashboards. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time, including availability of features, databases, or contents, without prior notice.'
  },
  {
    id: 'obligations',
    title: '3. User Obligations',
    icon: UserCheck,
    content: 'As a user of Verto, you agree to use the service only for lawful purposes. You are prohibited from:\n\n• Uploading any contents that infringe intellectual property or privacy rights.\n• Attempting to disrupt, disable, or hack the security infrastructure of Verto.\n• Deploying automated scraping, crawling, or extraction scripts without authorization.\n• Sharing workspace invite codes or access credentials with unauthorized external parties.'
  },
  {
    id: 'account',
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-8 text-center md:text-left">
        ...
        >
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-lg leading-relaxed">
            Last Updated: June 23, 2026. Please read these terms carefully before using the Verto platform and workspaces.
          </p>
        </motion.div>
      </section>
