...
router.patch('/:workspaceId', auth_middleware_1.authMiddleware, upload.single('image'), workspace_controller_1.updateWorkspace);
router.delete('/:workspaceId', auth_middleware_1.authMiddleware, workspace_controller_1.deleteWorkspace);
router.post('/:workspaceId/resetInviteCode', auth_middleware_1.authMiddleware, workspace_controller_1.resetInviteCode);
router.post('/:workspaceId/join', auth_middleware_1.authMiddleware, workspace_controller_1.joinWorkspace);
router.get('/:workspaceId/analytics', auth_middleware_1.authMiddleware, workspace_controller_1.getWorkspaceAnalytics);
