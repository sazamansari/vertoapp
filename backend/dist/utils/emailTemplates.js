...
exports.generateTaskCompletedEmail = exports.generateTaskReviewEmail = exports.generateTaskAssignedEmail = exports.generateOTPEmail = void 0;
...
const generateTaskAssignedEmail = (memberName, projectName, taskTitle, priority, dueDate, description) => {
    return `
  <!DOCTYPE html>
  <html>
  <head>
...
exports.generateTaskAssignedEmail = generateTaskAssignedEmail;
const generateTaskReviewEmail = (adminName, taskName, memberName) => {
    return `
  <!DOCTYPE html>
  <html>
  <head>
...
exports.generateTaskReviewEmail = generateTaskReviewEmail;
const generateTaskCompletedEmail = (adminName, taskName, memberName, completionTime) => {
    return `
  <!DOCTYPE html>
  <html>
  <head>
...
exports.generateTaskCompletedEmail = generateTaskCompletedEmail;
